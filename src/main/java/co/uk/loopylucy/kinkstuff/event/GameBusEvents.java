...
/**
 * Handles client-side events, primarily focused on rendering overlays and capturing user interactions.
 * This class operates exclusively on the logical client.
 */
