...
import co.uk.loopylucy.tameableplayers.common.item.MittensItem;
 ...
 * including applying the custom dye colour.
 */
public class MittensRenderer implements ICurioRenderer {
    /** Texture for the dyeable mittens. */
    private static final ResourceLocation BASE_TEXTURE = ResourceLocation.fromNamespaceAndPath(TameablePlayers.MODID, "textures/entity/mittens_dyeable.png");
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        if (renderLayerParent.getModel() instanceof HumanoidModel<?> humanoidModel) {
            ...
            // Fetch the dye colour from the item stack
            int colour = ((MittensItem)stack.getItem()).getColour(stack);
