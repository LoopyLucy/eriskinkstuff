package co.uk.loopylucy.tameableplayers.client.render;
...
public class SkinOverlayRenderer implements ICurioRenderer {
    ...
    private static void hideChildrenRecursive(ModelPart part) {
        ...
        try {
            if (modelPartChildrenField == null) {
                ...
                } catch (NoSuchFieldException e) { TameablePlayers.LOGGER.warn("Unable to get children: ", e); }
    ...
    private static void initializeReflectionHooks(Object layerInstance) {
        ...
        try {
            try {
                ...
                TameablePlayers.LOGGER.warn("Unable to get layers: ", e);
            }
            ...
            while (current != null && current != Object.class) {
                for (Method method : current.getDeclaredMethods()) {
                    ...
                    if (params.length >= 5 && params[0] == PoseStack.class && params[1] == MultiBufferSource.class) {
                        ...
                        TameablePlayers.LOGGER.info("[TameablePlayers] Bound to Gender Mod layer: {}", method.getName());
                        break;
                    }
                }
            ...
            TameablePlayers.LOGGER.error("[TameablePlayers] Hook init failed:", e);
    ...
    private void renderGenderModCompatibility(Player player, PoseStack matrixStack, MultiBufferSource renderTypeBuffer, int light,
        ...
        try {
            ...
            TameablePlayers.LOGGER.error("[TameablePlayers] Error executing parent layer rendering override: ", e);
        }
    }
